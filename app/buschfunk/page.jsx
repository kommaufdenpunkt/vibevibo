...
// 📣 Buschfunk v2 — WOW-Edition.
// Transparenter Hintergrund, großer animierter Hero, Glas-Wrapper um Feed,
// Mobile-optimiert, smooth scroll.
  ...
  if (!me) {
    return (
      <div style={{ padding: 24, maxWidth: 480, margin: "40px auto 0", textAlign: "center" }}>
        ...
        <h1 style={{ color: "#fff", textShadow: "0 2px 8px rgba(0,0,0,0.3)" }}>Buschfunk</h1>
