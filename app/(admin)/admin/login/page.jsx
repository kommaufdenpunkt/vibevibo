// Admin Login — separates Login für admin.vibevibo.de.
// Nutzt dieselben Credentials wie MCP (verifyMcpPassword), aber:
//   • setzt separates Cookie (vv_admin_session)
//   • erfordert STRENGERE Rolle (isAdminRole — nicht jeder Mod)
//   • erlaubt KEINE VPN/Proxy-Verbindungen (strict IP-Intel)
      ...
      >
        ...
        <div
          style={{
            ...
            marginBottom: 20,
            background:
              "linear-gradient(135deg, rgba(239, 68, 68, 0.22), rgba(220, 38, 38, 0.12))",
        ...
        <div style={{ textAlign: "center", marginBottom: 18 }}>
          <div
            style={{
              ...
              boxShadow:
                "0 12px 32px rgba(220, 38, 38, 0.35), inset 0 1px 0 rgba(255,255,255,0.2)",
              marginBottom: 12,
              fontSize: 26,
            }}
            aria-hidden="true"
        ...
        >
          NUR FÜR ADMINS. Mod-Rollen werden hier abgelehnt.
          <br />
