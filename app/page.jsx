...
import PwaApps from "@/components/PwaApps";
  ...
  return (
    <div className="vv-home-page" data-gender={me.gender || ""}>
      ...
      <div className="vv-home-tiles">
        <Link href="/profile" className="vv-home-tile" data-tone="pink"><span className="vv-home-tile-emoji">👤</span><span>Profil</span><span className="vv-home-tile-sub">Pinnwand & mehr</span></Link>
        <Link href="/messenger" className="vv-home-tile" data-tone="violet"><span className="vv-home-tile-emoji">✉️</span><span>Messenger</span><span className="vv-home-tile-sub">Chatten</span></Link>
        <Link href="/freunde" className="vv-home-tile" data-tone="cyan"><span className="vv-home-tile-emoji">👯</span><span>Freunde</span><span className="vv-home-tile-sub">{onlineUsers.length} online</span></Link>
        <Link href="/karte" className="vv-home-tile" data-tone="green"><span className="vv-home-tile-emoji">🗺️</span><span>Karte</span><span className="vv-home-tile-sub">Realität</span></Link>
        <Link href="/fotos" className="vv-home-tile" data-tone="gold"><span className="vv-home-tile-emoji">📸</span><span>Fotos</span><span className="vv-home-tile-sub">Galerie</span></Link>
        <Link href="/gruppen" className="vv-home-tile" data-tone="violet"><span className="vv-home-tile-emoji">🏘️</span><span>Gruppen</span><span className="vv-home-tile-sub">Forum</span></Link>
        <Link href="/geschenke" className="vv-home-tile" data-tone="red"><span className="vv-home-tile-emoji">🎁</span><span>Geschenke</span><span className="vv-home-tile-sub">verschicken</span></Link>
        <Link href="/profile/skin" className="vv-home-tile" data-tone="cyan"><span className="vv-home-tile-emoji">🎨</span><span>Skin</span><span className="vv-home-tile-sub">CSS-Design</span></Link>
        <Link href="/shop" className="vv-home-tile" data-tone="pink"><span className="vv-home-tile-emoji">🛍</span><span>Shop</span><span className="vv-home-tile-sub">✨ Features</span></Link>
        <Link href="/vibo" className="vv-home-tile" data-tone="gold"><span className="vv-home-tile-emoji">🥚</span><span>VIBO</span><span className="vv-home-tile-sub">Pet</span></Link>
      ...
      <div className="vv-home-grid">
          ...
          <div className="vv-home-card" data-tone="cyan">
            ...
            <div className="vv-home-card-body">
                ...
                <Link key={u.username} href={`/u/${u.username}`} className="vv-home-member-row">
                  ...
                  <span style={{ flex: 1, minWidth: 0, overflow: "hidden" }}>
                    <span style={{ display: "flex", alignItems: "center", gap: 5, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      <OnlineName lastSeen={u.lastSeen}><ColoredName gender={u.gender} age={u.age} name={u.displayName} /></OnlineName>
              ...
              <div style={{ textAlign: "center", marginTop: 8 }}>
                <Link href="/freunde" style={{ display: "inline-block", padding: "6px 12px", borderRadius: 999, background: "linear-gradient(135deg, #06b6d4, #0891b2)", color: "#fff", textDecoration: "none", fontSize: 11, fontWeight: 800 }}>→ Alle ansehen</Link>
              </div>
            </div>
          </div>
                ...
                {newest.map((u) => (
                  <Link key={u.username} href={`/u/${u.username}`} className="vv-home-member-row">
                    ...
                    <span style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {u.createdAt && (<span className="vv-home-member-mood">seit {new Date(u.createdAt).toLocaleDateString("de-DE", { day: "2-digit", month: "short" })}</span>)}
                    </span>
                  </Link>
                ))}
              </div>
        ...
        <div className="vv-home-col">
          <div className="vv-home-card" data-tone="pink">
            ...
            <div className="vv-home-card-body">
              <div style={{ fontSize: 11, opacity: 0.7, marginBottom: 8 }}>Erscheint auf deiner eigenen Wall und im Buschfunk</div>
          ...
          <div className="vv-home-card" data-tone="violet">
            <div className="vv-home-card-title">📣 WAS GIBT'S NEUES?</div>
            <div className="vv-home-card-body"><Buschfunk key={feedTick} /></div>
          </div>
        </div>
        ...
        <div className="vv-home-col">
          ...
          <div className="vv-home-card" data-tone="gold">
            ...
            <div className="vv-home-card-body">
              ...
              <Link href="/profile/transactions" style={{ display: "block", marginTop: 10, padding: "10px 12px", background: "linear-gradient(135deg, #fbbf24, #f59e0b)", color: "#fff", textAlign: "center", textDecoration: "none", fontWeight: 800, fontSize: 13, borderRadius: 10, border: "2px solid #b45309", boxShadow: "0 3px 0 #b45309" }}>✨ Meine Vibes</Link>
            </div>
          </div>
