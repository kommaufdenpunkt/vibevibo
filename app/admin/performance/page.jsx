// 🚀 Performance-Diagnose — Owner kann SQLite + Server-Settings analysieren + optimieren.
...
export default async function PerformancePage({ searchParams }) {
  ...
  return (
    <div style={{ maxWidth: 1080, margin: "0 auto", padding: "20px 16px 60px", fontFamily: "system-ui, sans-serif" }}>
