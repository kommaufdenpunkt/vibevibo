...
export const COM_FEATURES = [
  ...
  },
  {
    ...
    emoji: "🤝",
    label: "Meetup-Planer",
    description: "Plant echte Treffen mit Titel, Ort, Datum und Uhrzeit. Mitglieder sagen ✅ zu / 🤔 vielleicht / 🚫 ab. Optional: Max-Teilnehmer-Grenze. Fidolin prüft Titel + Beschreibung + Ort.",
    category: "social",
    costVibes: 600,
    memberGate: 8,
    available: true,
