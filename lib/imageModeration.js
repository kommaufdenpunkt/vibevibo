...
//
// 🔧 Schema wird LAZY beim ersten DB-Zugriff erstellt (idempotent) — damit
// die Tabellen auch auf der PROD-DB existieren, ohne separates Migrations-Skript
// ausführen zu müssen.
...
export function ensureImageModerationSchema(database) {
  ...
  // 4) Default-Templates seeden (nur wenn leer)
