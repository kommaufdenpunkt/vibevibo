...
export const PREMIUM_ITEMS = [
  // ---- Profilbild-Slots (3 Stufen — jede Stufe nur 1× freischaltbar) ----
  {
    kind: "extra_pic_slots",
    name: "+5 Profilbild-Slots",
    emoji: "📸",
    price: 750,
    description: "Lade bis zu 14 statt 9 Profilbilder hoch. Permanent — nur einmal freischaltbar.",
    permanent: true,
    bonus: 5,
    group: "slots",
  },
  {
    ...
    emoji: "📷",
    price: 1600,
    description: "Lade insgesamt 24 statt 9 Profilbilder hoch. Permanent — nur einmal freischaltbar.",
    permanent: true,
    bonus: 10,
    group: "slots",
  },
  {
    ...
    emoji: "🖼️",
    price: 4500,
    description: "Bis zu 49 Profilbilder. Für ausführliche Galerie-Sammler. Permanent — nur einmal freischaltbar.",
    permanent: true,
    bonus: 25,
    group: "slots",
  },
  ...
  // ---- Name & Identität ----
  {
    ...
    emoji: "🏷️",
    price: 2500,
    description: "Neuer Anzeigename — muss einzigartig sein. Pro Änderung. Identitätswechsel ist teuer.",
    permanent: false,
    group: "name",
  },
  {
    ...
    emoji: "🎫",
    price: 6500,
    description: "3 Namens-Wechsel auf Vorrat (sonst 3×2500=7500 ✨). Speichert 3 Guthaben.",
    permanent: false,
    pack: 3,
    group: "name",
  },
  ...
  // (Vanity-URL aus dem Shop genommen — die Funktion ist noch nicht implementiert.)
  ...
  },
  {
    ...
    emoji: "👻",
    price: 5500,
    description: "Niemand sieht wann du online bist. Du siehst andere weiterhin. Permanent. Premium-Stealth ist teuer.",
    permanent: true,
    group: "status",
  },
  ...
  },
  {
    ...
    emoji: "💠",
    price: 35000,
    description: "Komplett werbefrei für 365 Tage. Spart gegenüber 12×4500 = 54000 ✨. Stapelbar.",
    permanent: false,
    durationDays: 365,
    group: "vip",
  },
  ...
  },
  {
    ...
    emoji: "📢",
    price: 550,
    description: "Drei Boosts auf Vorrat (statt 3×200=600 ✨). Verfällt nach 30 Tagen ungenutzt.",
    permanent: false,
    pack: 3,
    group: "boosts",
