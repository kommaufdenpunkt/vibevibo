...
export const STATUS_CATS = [
  // === BASIC — immer verfügbar (erweitert) ===
  { title: "📍 Wo bin ich?", packId: null, items: [
    ...
    ["✈️", "im Flieger"], ["🚌", "im Bus"], ["🏞️", "in der Natur"], ["🏥", "im Krankenhaus"],
    ["🏋️", "im Gym"], ["💒", "auf Hochzeit"], ["🎢", "im Freizeitpark"], ["🍽️", "im Restaurant"],
    ["🌃", "in der Stadt unterwegs"], ["🏨", "im Hotel"], ["🌉", "auf Reisen"], ["🎭", "im Theater"],
  ] },
  { title: "🎯 Was mache ich?", packId: null, items: [
    ...
    ["🛁", "baden"], ["🚿", "duschen"], ["🧘", "meditieren"], ["💻", "am PC"], ["🎨", "kreativ"],
    ["🧑‍🎤", "Karaoke"], ["📝", "schreiben"], ["🛏️", "ausschlafen"], ["💆", "entspannen"],
    ["🧹", "putzen"], ["🚴", "Rad fahren"], ["🐕", "Gassi gehen"], ["✏️", "Hausaufgaben"],
  ] },
  { title: "💭 Wie geht's mir?", packId: null, items: [
    ...
    ["🤤", "hungrig"], ["🥶", "frierend"], ["🥵", "geschafft"], ["🧠", "konzentriert"],
    ["🦋", "freischwebend"], ["🌈", "hoffnungsvoll"], ["🌙", "nachdenklich"], ["🔥", "voll im Flow"],
    ["✨", "magisch"], ["😇", "dankbar"], ["🤗", "knuddelig"], ["💯", "perfekt"],
  ] },
  { title: "🌤 Wetter & Stimmung", packId: null, items: [
    ["☀️", "Sonne tanken"], ["🌧️", "Regen-Tag"], ["❄️", "Schnee-Mood"], ["⛈️", "Sturm"],
    ["🌤", "halbschön"], ["🌫", "neblig"], ["🌞", "Sommer-Vibes"], ["🍂", "Herbst-Vibes"],
    ["🌸", "Frühlings-Vibes"], ["☃️", "Winter-Wonderland"], ["🌊", "am Meer"], ["⛱️", "Sandstrand"],
  ] },
