...
// Steile Kurve — Endrang 200 ist ein Lebenswerk, kein Wochenend-Grind.
// Rang 1: 200 · Rang 10: 20.000 · Rang 50: 500.000
// Rang 100: 2.000.000 · Rang 150: 4.500.000 · Rang 200: 8.000.000
export function xpForRank(rank) {
  if (rank <= 0) return 0;
  return Math.ceil(rank * rank * 200);
}
...
// Per-Aktion XP-Beträge — bewusst niedrig, damit der Endrang langfristig ist.
...
// Tages-Caps pro Quelle — verhindert Farming. Wer nicht spamt, kriegt alles.
// Bei Überschreiten wird die XP-Quelle bis Mitternacht stumm geschaltet.
export const XP_DAILY_CAPS = {
  pinnwand_post:   20,  // max 10 Einträge/Tag = 20 XP
  guestbook_post:  20,
  gift_send:       15,
  gift_recv:       40,
  compliment_send: 10,
