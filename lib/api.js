...
export const api = {
  ...
  listBuschfunkComments: (postId) => req(`/api/buschfunk/${postId}/comments`),
  addBuschfunkComment: (postId, text, replyToId = 0) =>
    req(`/api/buschfunk/${postId}/comments`, { method: "POST", body: JSON.stringify({ text, replyToId }) }),
  deleteBuschfunkComment: (postId, commentId) =>
    req(`/api/buschfunk/${postId}/comments?cid=${commentId}`, { method: "DELETE" }),
