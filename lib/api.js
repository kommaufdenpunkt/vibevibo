...
export const api = {
  ...
  // 🚫 Hard-Block
  blockUser: (username, reason = "") =>
    req(`/api/users/${encodeURIComponent(username)}/block`, {
      method: "POST", body: JSON.stringify({ reason }),
    }),
  unblockUser: (username) =>
    req(`/api/users/${encodeURIComponent(username)}/block`, { method: "DELETE" }),
  listMyBlocks: () => req("/api/me/blocks"),
};
