...
export const api = {
  ...
  // 💑 Familienstand setzen + optional Partner verlinken + optional in Buschfunk posten
  setRelationship: ({ status, partnerUsername, announceBuschfunk }) =>
    req("/api/me/relationship", { method: "POST", body: JSON.stringify({ status, partnerUsername, announceBuschfunk }) }),
